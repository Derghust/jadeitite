...
void onAttach(int p_argc, char **p_argv) {
  s_clear_color_renderer.x = 32;
  s_clear_color_renderer.y = 32;
  s_clear_color_renderer.z = 32;
...
void onUpdate(void) {
  ...
  set_render_color(255, 0, 0);
  draw_bitmaps(8, 8, font8x8_basic, 32, 32, "Hello, World!");
